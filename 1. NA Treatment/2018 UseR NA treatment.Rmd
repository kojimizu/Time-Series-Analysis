...
### Perform regression
MI aims to apply a statistical method on an incomplete dataset. We now apply a regression model on each imputed dataset of the amelia method and MIPCA methods. 
```{r}
...
We combine the results and pefrom the **regression with missing values**
```{r}
#submodel to compare
